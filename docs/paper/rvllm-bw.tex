...
SXM4, rvLLM with FP16 inference achieves 10{,}291~tok/s serving Qwen2.5-1.5B,
\textbf{beating Python vLLM~0.18 throughput up to $N\!=\!256$ concurrent requests}
...
(5)~fixed CUDA graph replay eliminating redundant forward passes, and (6)~a zero-copy
...
\begin{enumerate}
  ...
  \item Verified benchmark results: 10{,}291~tok/s peak on A100 (FP16), beating
        Python vLLM up to $N\!=\!256$, with coherence verified across 14{,}620 total
...
\begin{table}[t]
  \centering
  \caption{A100 80\,GB SXM4 head-to-head. Qwen2.5-1.5B, greedy, 32 tok/req. rvLLM FP16 (optimised) vs Python vLLM~0.18.}
  \label{tab:a100}
  \small
